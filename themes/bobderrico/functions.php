...
function bobderrico_setup() {
	...
	add_theme_support( 'custom-background', apply_filters( 'bobderrico_custom_background_args', array(
...
function bobderrico_scripts() {
	wp_enqueue_style( 'bobderrico-style', get_stylesheet_uri() );

	wp_enqueue_script( 'bobderrico-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20120206', true );

	wp_enqueue_script( 'bobderrico-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20130115', true );
